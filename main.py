...
class ImageKernel:
    ...
    def Process(self, data):
        ...
        try:
            ...
            if (count < 45):
                count = 255
                # output video and model
                self.out.putpixel(self.location1, (count))
                self.out.putpixel(self.location2, (count))
                self.out.putpixel(self.location3, (count))
                self.out.putpixel(self.location4, (count))
                self.out.putpixel(self.location5, (count))
                self.out.putpixel(self.location6, (count))
                self.out.putpixel(self.location7, (count))
                self.out.putpixel(self.location8, (count))
                self.out.putpixel(self.location9, (count))
